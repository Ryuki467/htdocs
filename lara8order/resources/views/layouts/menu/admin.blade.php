    		...
    		<ul class="navbar-nav mr-auto">
    			<li class="nav-item dropdown">
    				...
    				<ul class="dropdown-menu">
    					...
    					<li><a href="{{route('admin.order.create')}}" class="nav-link">新規登録</a></li>
    				</ul>
    			</li>
    			<li class="nav-item dropdown">
    				<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">商品</a>
    				<ul class="dropdown-menu">
    					<li><a class="nav-link" href="{{route('admin.product.index')}}">一覧</a></li>
    					<li><a class="nav-link" href="{{route('admin.product.create')}}">新規登録</a></li>
    				</ul>
    			</li>
    			<li class="nav-item dropdown">
    				<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">顧客</a>
    				<ul class="dropdown-menu">
    					<li><a class="nav-link" href="{{route('admin.customer.index')}}">一覧</a></li>
    					<li><a class="nav-link" href="{{route('admin.customer.create')}}">新規追加</a></li>
    				</ul>
    			</li>
    		</ul>
