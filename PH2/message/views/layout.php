...
<head>
	...
	<title><?php if(isset($title)): echo $this->escape($title) . ' - '; endif; ?>メッセンジャーアプリ</title>
	<link rel="stylesheet" type="text/css" media="screen" href="<?php echo $base_url; ?>/css/style.css" />
</head>
<body>
	<div id="header">
		<h1><a href="<?php echo $base_url; ?>/">メッセンジャーアプリ</a></h1>
	</div>
	<div id="nav">
		<p>
    		<?php if($session->isAuthenticated()): ?>
        		...
        		<a href="<?php echo $base_url; ?>/groups/update">グループ一覧</a>
