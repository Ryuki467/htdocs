...
<table>
	<tr>
		<th>名前</th>
		<td><input type="text" name="name" value="<?php echo $this->escape($employee["name"]); ?>" /></td>
	</tr>
	<tr>
		<th>年齢</th>
		<td><input type="text" name="age" value="<?php echo $this->escape($employee["age"]); ?>" /></td>
	</tr>
	<tr>
		<th>住所</th>
		<td><input type="text" name="address" value="<?php echo $this->escape($employee["address"]); ?>" /></td>
	</tr>
	<tr>
		<th>部署</th>
		<td>
