...
abstract class Controller
{
    ...
    public function run($action, $params = array())
    {
        ...
        //実行するclassの名前addActionなどが代入される
        $action_method = $action . 'Action';
        //method_exists クラスメソッドが存在するかどうかを確認する
        //$this 呼び出し中のContllerの中身等が見れる
        ...
        //$content　var_dumpすると画面がもう一つ表示される ページの実行画面
    ...
    {
        //is_array 与えられた変数が配列かどうかを検査します。
        //in_array($action,$this->auth_actions)) $this->auth_actions内の$actionを検索
